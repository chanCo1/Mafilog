...
const chipVariants = cva(
  'flex gap-1 cursor-pointer font-medium rounded-2xl items-center justify-center disabled:pointer-events-none disabled:opacity-50 hover:opacity-90 text-white w-fit',
  {
    variants: {
      variant: {
        primary: 'bg-primary',
